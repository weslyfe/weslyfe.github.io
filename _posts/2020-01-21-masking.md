---
layout: post
title: Using masks to improve reconstructions of artifacts in archaeological photogrammetry.
---
...
---
<h4><p style="text-align: center;"> "<i>Take a bunch of photos and the software stitches them together. Easy as pie!</i>"</p></h4>
...
<h3><p style="text-align: center;"> "<i>Metashape's Magic Wand!</i>*"</p></h3>
...
---
<h4><p style="text-align: center;"> "<i>Choose a backdrop colour that highly contrasts the colour(s) of the object being modelled.</i>"</p></h4>
...
associated with the object. No masking is required here. You can likely clean the model 
and continue onto later processing steps.
