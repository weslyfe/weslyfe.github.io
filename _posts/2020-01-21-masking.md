...
---
#### <p style="text-align: center;"> "*Take a bunch of photos and the software stitches them together. Easy as pie!*"</p>
---
...
### <p style="text-align: center;"> "*Metashape's Magic Wand!*"</p>
...
---
 #### <p style="text-align: center;"> "*Choose a backdrop colour that highly contrasts the colour(s) of the object being modelled.*"</p>
---
